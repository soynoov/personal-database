...
- **Espaciado:** hero de altura automática con portada completa; filtros y filas de completados con padding interior; pastillas móviles en filas adaptables y valores económicos sin elipsis. El botón de AppID ocupa 28 px visuales con un área de interacción de 44 px; las etiquetas técnicas quedan alineadas arriba sin inflar la fila.
...
- Horas sin HLTB presenta la cifra y sus fechas en una fila cuando hay espacio. En juegos recurrentes, «Periodo» e «Inicio» se apilan en dos filas compactas junto a la cifra, compartiendo su altura; hasta 700 px quedan debajo, con el icono al lado del texto. Las alturas dependen del contenido; la fórmula ya disponible en el desplegable no se repite junto a la barra. Portada, progreso, notas, rango y métricas secundarias reducen espacio sobrante sin ocultar sus datos.
